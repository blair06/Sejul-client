            ...
            <div className="__navbar-wrap">
                <ul className="__navbar-links" >
                    <li className="__navbar-link-item" >
                        <div className="__btn" onClick={props.onClick}><NavLink to="/search/newsearch">기사검색</NavLink></div>
                    </li>
                    <li className="__navbar-link-item">
                        <div className="__btn" onClick={props.onClick}><NavLink to="/search/postsearch">글검색</NavLink></div>
                    </li>
                </ul>
            </div>
        </>
